...
public class LihatJadwalActivity extends AppCompatActivity {
    ...
    public class JadwalAdapter extends RecyclerView.Adapter<JadwalAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.switchAktif.setChecked(Boolean.TRUE.equals(jadwal.aktif));
            ...
            // Set status nonaktif
            holder.switchNonaktif.setOnCheckedChangeListener(null);
            holder.switchNonaktif.setChecked(Boolean.TRUE.equals(jadwal.nonaktif));

            holder.switchNonaktif.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (jadwal.id_jadwal != null) {
                    dbRef.child(jadwal.id_jadwal).child("aktif").setValue(isChecked)
                            .addOnSuccessListener(unused -> Toast.makeText(context, "Status diperbarui", Toast.LENGTH_SHORT).show())
                            .addOnFailureListener(e -> Toast.makeText(context, "Gagal memperbarui status", Toast.LENGTH_SHORT).show());
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ImageView btnDelete;
            Switch switchAktif, switchNonaktif;
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                switchNonaktif = itemView.findViewById(R.id.switchNonaktif);
            }
        }
    }
