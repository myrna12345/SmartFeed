...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ambil data pakan dan jadwal dari Firebase
        ambilDataPakanDariFirebase();
        ambilJadwalAktifTerdekat();

        // Ambil nama pengguna dari Firebase (opsional)
        ambilNamaPengguna();
                ...
                for (String waktu : waktuAktifList) {
                    try {
                        ...
                        if (waktuDate != null) {
                            ...
                            jadwalCal.set(Calendar.HOUR_OF_DAY, waktuDate.getHours());
                            jadwalCal.set(Calendar.MINUTE, waktuDate.getMinutes());
